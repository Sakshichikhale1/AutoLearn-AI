      ...
      <div className="hidden lg:flex flex-col items-center justify-center p-12 relative overflow-hidden bg-primary/5">
        ...
        <div className="relative z-10 text-center space-y-8 max-w-lg">
          <div className="relative group mx-auto w-fit">
            <div className="absolute -inset-4 bg-gradient-to-r from-primary via-purple-500 to-pink-500 rounded-3xl blur-xl opacity-40 group-hover:opacity-70 transition duration-1000 group-hover:duration-200"></div>
            <div className="relative h-28 w-28 rounded-3xl bg-card border-2 border-primary/20 shadow-2xl flex items-center justify-center animate-float">
